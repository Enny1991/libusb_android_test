...
public class Main extends AppCompatActivity {
    ...
    public void onClickStartNew(final MenuItem item){
    ...
    private static final List<List<String>> devTests = Arrays.asList(
            ...
            Arrays.asList("libusbaudio.so", "-i", "%1$04x:%2$04x")
    );
    ...
    static private String formatDevice(String fmt, UsbDevice device) {
        return String.format(fmt, device.getVendorId(), device.getProductId(), null);
    }
    ...
    private static final String ACTION_USB_PERMISSION = "com.eneaceolini.testusb.USB_PERMISSION";
